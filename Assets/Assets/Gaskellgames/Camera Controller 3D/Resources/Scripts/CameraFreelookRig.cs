...
namespace Gaskellgames.CameraController3D
{
    public class CameraFreelookRig : MonoBehaviour
    {
        ...
        {
            // get mouse input
            float mouseX = inputActionsGaskellgames.Universal.InputAxis45.ReadValue<Vector2>().x * Time.deltaTime * xSensitivity * 2;
            float mouseY = inputActionsGaskellgames.Universal.InputAxis45.ReadValue<Vector2>().y * Time.deltaTime * ySensitivity * 2;
